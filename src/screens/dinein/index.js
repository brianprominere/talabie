...
class DineIn extends Component {
    ...
    super(props);
    this.state = {
      tableHead: ['Order #', 'Tips', 'Sub Total', 'Tax', 'Total Paid', 'Time & Date', 'Status'],
      tableData: [
        ['01', '$ 02.00', '$ 16.00', '$ 02.00', '$ 20.00', '12:00 AM 11 Nov 2017', '1'],
        ['02', '$ 02.00', '$ 16.00', '$ 02.00', '$ 20.00', '12:00 AM 11 Nov 2017', '2'],
        ['03', '$ 02.00', '$ 16.00', '$ 02.00', '$ 20.00', '12:00 AM 11 Nov 2017', '3'],
        ['04', '$ 02.00', '$ 16.00', '$ 02.00', '$ 20.00', '12:00 AM 11 Nov 2017', '4'],
      ]
    }
  }
  ...
  render() {
    ...
    const element = (data, index) => (
      <Button small style={styles.btn} onPress={() => this.props.navigation.navigate("DineInView")}>
      ...
      <Container>
        <Header>
          ...
          <Content padder style={{backgroundColor: '#f5f5f5'}}>
              <H1 style={styles.headline}>DineIn</H1>
              <Card>
