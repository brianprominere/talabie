...
import { Header, Left, Right, Icon, Badge, Container, Content, H1, Card, Button } from 'native-base';
        ...
        <Header>
          ...
          <Content padder style={{backgroundColor: '#f5f5f5'}}>
              <View style={{flexDirection: 'row'}}>
                <H1 style={styles.headline}>Dine in</H1>
            ...
            <Card>
              <Grid style={{borderBottomWidth: 2, borderBottomColor: '#C5C5C5', marginTop: 10}}>
                <Row style={{marginLeft: 10,}}>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>Table</Text></Col>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>Name</Text></Col>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>Order Time</Text></Col>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>Status</Text></Col>
                </Row>
                <Row style={{marginLeft: 10,}}>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>5</Text></Col>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>Prabakar</Text></Col>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>9 Nov 2017, 09:00 AM</Text></Col>
                  <Col style={{width: '24%'}}><Text style={styles.textview2}>Table</Text></Col>
                </Row>
              </Grid>
